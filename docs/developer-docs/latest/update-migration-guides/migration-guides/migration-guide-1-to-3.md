...
有关更多信息 [new documentation](https://github.com/strapi/strapi/blob/master/docs/3.0.0-x/en/configurations/configurations.md) to set the correct values in each file.
